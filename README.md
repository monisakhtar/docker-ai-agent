...
2. **Configure environment variables**
   ...
   | `OPENAI_BASE_URL` | Base URL for the OpenAI-comp# Docker AI Agent
...
No license file is currently included in this repository. Add one (e.g. MIT, Apache-2.0) if you intend for others to reuse this code.atible LLM endpoint | Docker Model Runner (`http://model-runner.docker.internal/engines/v1/`) |
   | `OPENAI_API_KEY` | API key for the LLM endpoint. **Required** — the app raises an error at import time if this is unset | *(empty)* |
   | `OPENAI_MODEL` | Model name/tag to use | `ai/gemma3:270M-F16` |
